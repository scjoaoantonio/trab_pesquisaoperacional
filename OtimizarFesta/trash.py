...
# model.addConstraint(x[1] <= 30, 'restricao_a1')
# model.addConstraint(x[2] <= 30, 'restricao_a2')
# model.addConstraint(x[3] <= 30, 'restricao_a3')
# model.addConstraint(x[4] <= 30, 'restricao_a4')
# model.addConstraint(x[5] <= 30, 'restricao_a5')
# model.addConstraint(x[9] <= 30, 'restricao_a9')
# model.addConstraint(x[6] <= 30, 'restricao_a6')
# model.addConstraint(x[7] <= 30, 'restricao_a7')
# model.addConstraint(x[8] <= 30, 'restricao_a8')
# model.addConstraint(x[10] <= 30, 'restricao_a10')
