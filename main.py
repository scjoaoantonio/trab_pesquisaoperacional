...
model.addConstraint(x[1] <= valormax/10, 'restricao_a1')
model.addConstraint(x[2] <= valormax/10, 'restricao_a2')
model.addConstraint(x[3] <= valormax/10, 'restricao_a3')
model.addConstraint(x[4] <= valormax/10, 'restricao_a4')
model.addConstraint(x[5] <= valormax/10, 'restricao_a5')
model.addConstraint(x[9] <= valormax/10, 'restricao_a9')
model.addConstraint(x[6] <= valormax/10, 'restricao_a6')
model.addConstraint(x[7] <= valormax/10, 'restricao_a7')
model.addConstraint(x[8] <= valormax/10, 'restricao_a8')
model.addConstraint(x[10] <= valormax/10, 'restricao_a10')
if (festa == 1):
    # criança
